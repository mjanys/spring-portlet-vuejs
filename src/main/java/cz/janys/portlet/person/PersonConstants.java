...
import cz.janys.portlet.Constants;
...
public class PersonConstants extends Constants {
    ...
    public static final String PERSON_FORM_EDIT_PAGE = "editForm";
    public static final String PERSON_FORM_CREATE_PAGE = "createForm";
    public static final String PERSON_DETAIL_PAGE = "detail";
